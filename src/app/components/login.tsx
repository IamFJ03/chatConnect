   ...
   const[password, setPassword] = useState("");
    ...
    return (
        <div className="">
            ...
            <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Email" className="border border-gray-600 px-3 py-1 md:w-70 rounded" required/>
            <p className="text-lg my-3">Enter Password:</p>
            <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Password" className="border border-gray-600 px-3 py-1 md:w-70 rounded" required/><br />
